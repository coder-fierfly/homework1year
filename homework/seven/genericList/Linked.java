...
interface Linked<E> {
     ...
     * @return истина, если этот список изменился в результате вызова
     */
    boolean addAll(int index, Linked<E> c);
     ...
     */
    Linked<E> subList(int fromIndex, int toIndex);
     ...
     */
    boolean containsAll(Linked<E> c);
}
